...
def build_workflow_contracts(
    ...
    return {
        ...
        "reporter": NodeContract(name="reporter", consumes={"research_state": state_field, "research_state.plan": ContractField(dict), "research_state.evidence_store": ContractField(list)}, produces=frozenset({"research_state.final_report", "research_state.draft_report", "research_state.report_footnote_evidence", "research_state.current_phase"}), invariants=(identity, footnotes)),
