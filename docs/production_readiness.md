...
| Capability registry | Partial beyond fixed resolution | Search, fetch and structured provider carry metadata plus ToolSpec; optional deterministic selector records candidate/selected/rejected/fallback | `DYNAMIC_CAPABILITY_ENABLED=false`; skill capability registration belongs to 017 |
