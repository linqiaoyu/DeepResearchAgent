...
def run_gate() -> None:
    ...
    commands = (
        ...
        (
            "finance_default_capabilities",
            [
                sys.executable,
                "scripts/check_finance_default_capabilities.py",
                "--self-test",
            ],
        ),
        (
        ...
        (
            "report_evidence_selection",
            [sys.executable, "scripts/check_report_evidence_selection.py", "--self-test"],
        ),
        (
            "reporter_selection_coverage",
            [sys.executable, "scripts/check_reporter_selection_coverage.py", "--self-test"],
        ),
        (
        ...
        (
            "skills_contract",
            [sys.executable, "scripts/check_skills_contract.py", "--self-test"],
        ),
        (
            "skills_runtime",
        ...
        (
            "content_security_ingress",
            [sys.executable, "scripts/check_content_security_ingress.py", "--self-test"],
        ),
        (
