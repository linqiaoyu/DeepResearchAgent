...
- `prompts/`：当前存在 `critic.md`、`extractor.md`、`planner.md`、`reporter.md`。
- `scripts/`：`run_demo.py`、`run_eval.py`、`run_checkpoint_demo.py`、`dev_server.py`、`record_structured_data_fixture.py`。
...
未在 005 任务验证的命令：`scripts/run_eval.py`、`scripts/run_checkpoint_demo.py`、`scripts/dev_server.py`、FastAPI/Uvicorn 入口、Streamlit 入口、Docker/Compose 入口。
